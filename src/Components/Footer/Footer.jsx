                ...
                <div className='w-[80%] mx-auto flex flex-col md:flex-row lg:flex-row gap-3 items-center justify-between py-10'>
                    ...
                    <div className='flex items-center justify-center gap-4'>
                        <div className="flex gap-4 mt-3 text-xl">
                            <Link to="#" className="footer-social-icon"><FaFacebook /></Link>
                            <Link to="#" className="footer-social-icon"><FaTwitter /></Link>
                            <Link to="#" className="footer-social-icon"><FaInstagram /></Link>
                            <Link to="#" className="footer-social-icon"><FaLinkedin /></Link>
                        </div>
                        <div
                            onClick={scrollToTop}
